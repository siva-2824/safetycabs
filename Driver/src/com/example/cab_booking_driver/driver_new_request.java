...
public class driver_new_request extends Activity {
	//EditText e1;
	//Button b1;
...
//	public static String index[]=new String[100];
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_driver_new_request); 
...
//       
        ...
        listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {  
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,  
               ...
               //  Log.i("id", arrSplit[0]);  
                Toast.makeText(driver_new_request.this,test.trim() ,Toast.LENGTH_LONG);
...
//        	                MainActivity.this.finish();
        	            	final Dialog dialog = new Dialog(driver_new_request.this);
        	                dialog.setContentView(R.layout.closing_slot);
        	                dialog.setCancelable(false);
        	               
        	                dialog.setTitle("Request");
        	              
        	                Button send = (Button) dialog.findViewById(R.id.button1);
        	                final EditText amt = (EditText) dialog.findViewById(R.id.editText1);
        	                send.setText("Accept");
...
public void commonRequest()
{
    ...
    HttpPost httppost = new HttpPost("http://"+MainActivity.sip+"/driver_new_request.php");
    InputStream is = null;
    String result = "";
    ...
    try {
       ...
       // System.out.println("user_login.uemail: "+user_login.uemail);
        ...
        nameValuePairs.add(new BasicNameValuePair("l1",a1));
...
public class userlogin extends AsyncTask<String, String, String> {
    ...
    protected void onPreExecute() {
        super.onPreExecute();
        pDialog = new ProgressDialog(driver_new_request.this);
