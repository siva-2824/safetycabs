...
public class driver_payment extends Activity {
	//EditText e1;
	//Button b1;
...
//       
        ...
        listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {  
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,  
               ...
               //  Log.i("id", arrSplit[0]);  
                Toast.makeText(driver_payment.this,test.trim() ,Toast.LENGTH_LONG);
...
public void commonRequest()
{
    ...
    HttpPost httppost = new HttpPost("http://"+MainActivity.sip+"/driver_payment_detailst.php");
    InputStream is = null;
    String result = "";
...
public class userlogin extends AsyncTask<String, String, String> {
    ...
    protected void onPreExecute() {
        super.onPreExecute();
        pDialog = new ProgressDialog(driver_payment.this);
