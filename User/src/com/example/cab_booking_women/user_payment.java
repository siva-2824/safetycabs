...
public class user_payment extends Activity {
	//EditText e1;
	//Button b1;
...
//       
        ...
        listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {  
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,  
               ...
               //  Log.i("id", arrSplit[0]);  
                Toast.makeText(user_payment.this,test.trim() ,Toast.LENGTH_LONG);
                 //e1.setText(arrSplit[0]);
                 id=arrSplit[0].trim();
                 Log.i("Selected Item in list", id);  
//                 driver_new_request.id=id;
                 Intent in = new Intent(getApplicationContext(), user_payment_1.class);
                 startActivity(in);
...
public void commonRequest()
{
    ...
    HttpPost httppost = new HttpPost("http://"+MainActivity.sip+"/user_payment_detailst.php");
    InputStream is = null;
    String result = "";
...
public class userlogin extends AsyncTask<String, String, String> {
    ...
    protected void onPreExecute() {
        super.onPreExecute();
        pDialog = new ProgressDialog(user_payment.this);
