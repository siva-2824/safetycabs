...
public class user_home extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		payment1 = (TextView) findViewById(R.id.txt3);
		...
		view_booking.setOnClickListener(new OnClickListener() 
        {
			@Override
			public void onClick(View arg0) {
				 Intent in = new Intent(getApplicationContext(), user_view_booking.class);
		         startActivity(in);				 			
			}
        });
		...
		payment.setOnClickListener(new OnClickListener() 
        {
			...
			@Override
			public void onClick(View arg0) {
				 Intent in = new Intent(getApplicationContext(), user_payment.class);
		         startActivity(in);	
