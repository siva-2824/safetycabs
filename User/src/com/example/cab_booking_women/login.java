...
public class login extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		useremail.setText("rose@gmail.com");
		password.setText("123");
		ttl.setText("User Login");
		...
		String	lpass=password.getText().toString();
		        ...
		        protected String doInBackground(String... args) {
		            ...
		            try {
		                ...
		                String ur = "http://"+MainActivity.sip+"/user_login.php?"+ "uname=" + lname + "&pword=" +lpass;
		...
		String	lpass=password.getText().toString();
		        ...
		        protected String doInBackground(String... args) {
		            ...
		            try {
		                ...
		                String ur = "http://"+MainActivity.sip+"/user_mobile.php?"+ "uname=" + lname + "&pword=" +lpass;
