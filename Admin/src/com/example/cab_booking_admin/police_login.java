...
public class police_login extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		useremail.setHint("Mobile No");
		//useremail.setText("arun@gmail.com");
		//password.setText("123");
		ttl.setText("Police Login");
	...
	public class userlogin extends AsyncTask<String, String, String> {
		...
		String	lpass=password.getText().toString();
		        ...
		        protected void onPreExecute() {
		            super.onPreExecute();
		            pDialog = new ProgressDialog(police_login.this);
		        ...
		        protected String doInBackground(String... args) {
		            ...
		            try {
		                ...
		                String ur = "http://"+MainActivity.sip+"/police_login.php?"+ "uname=" + lname + "&pword=" +lpass;
		          ...
		          if (file_url.trim().equals("success")) {
		        	  ...
		        	  uemail=lname;
		               ...
		               // new userlogin1().execute();	
		               	...
		               	finish();
			             Intent in = new Intent(getApplicationContext(), police_home.class);
		          startActivity(in);
