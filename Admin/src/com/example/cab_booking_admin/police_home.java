...
//       
        ...
        listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {  
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,  
               ...
               //  Log.i("id", arrSplit[0]);  
                Toast.makeText(police_home.this,test.trim() ,Toast.LENGTH_LONG);
                 //e1.setText(arrSplit[0]);
                 id=arrSplit[0].trim();
                 Log.i("Selected Item in list", id);  
                 id=id;
               
           	  Intent i = new Intent(police_home.this,mapview1.class);
...
public void commonRequest()
{
    ...
    HttpPost httppost = new HttpPost("http://"+MainActivity.sip+"/police_emergency_details.php");
    InputStream is = null;
    String result = "";
    ...
    try {
       ...
       // System.out.println("user_login.uemail: "+user_login.uemail);
        ...
        nameValuePairs.add(new BasicNameValuePair("police",police_login.uemail));
...
public class userlogin extends AsyncTask<String, String, String> {
    ...
    protected void onPreExecute() {
        super.onPreExecute();
        pDialog = new ProgressDialog(police_home.this);
    ...
    protected String doInBackground(String... args) {
        ...
        try {
            ...
            String ur = "http://"+MainActivity.sip+"/driver_new_request_update.php?id="+id+"&driver="+police_login.uemail
            		+"&amount="+bid
            		+"&l1="+a1
            		+"&l2="+a2
            		;
