...
echo $result=$res['id'].'#'.$res['user'].'#'.$res['source'].'#'.$res['destination'].'#'.$res['driver_name'].'#'.$driver_name.'#'.$driver_contact.'#'.$driver_email.'#'.$driver_address.'#'.$driver_license_no.'#'.$driver_vehicle_name.'#'.$driver_vehicle_no.'#'.$res['distance'].'#'.$res['start_time'].'#'.$res['avg_duration'];
}
